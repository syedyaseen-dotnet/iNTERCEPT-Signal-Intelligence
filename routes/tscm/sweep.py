...
def get_tscm_devices():
    ...
    devices = {"wifi_interfaces": [], "bt_adapters": [], "sdr_devices": []}
    ...
    return jsonify({"status": "success", "devices": devices, "running_as_root": running_as_root, "warnings": warnings})
...
def get_capabilities():
    ...
    try:
        ...
        caps = detect_sweep_capabilities(wifi_interface=wifi_interface, bt_adapter=bt_adapter)

        return jsonify({"status": "success", "capabilities": caps.to_dict()})
